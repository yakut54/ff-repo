...
import 'sigh_in_page_model.dart';
export 'sigh_in_page_model.dart';

class SighInPageWidget extends StatefulWidget {
  const SighInPageWidget({
    super.key,
    this.phone,
  });
  ...
  @override
  State<SighInPageWidget> createState() => _SighInPageWidgetState();
}

class _SighInPageWidgetState extends State<SighInPageWidget> {
  late SighInPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SighInPageModel());
                  ...
                  children: [
                    FFButtonWidget(
                      onPressed: functions.isTextLessThen(
                          ...
                          : () async {
                              ...
                              context.pushNamed('CodeVerifyPage');
                    ...
                    RichText(
                      ...
                      text: TextSpan(
                        children: [
                          TextSpan(
                            text: 'Нажимая кнопку «Далее» вы соглашаетесь с ',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'Akrobat',
                          ...
                          TextSpan(
                            text: 'политику персональных данных',
                            style: TextStyle(
                              color: FlutterFlowTheme.of(context).primaryText,
                              decoration: TextDecoration.underline,
                            ),
