...
import 'user_name_popup_model.dart';
export 'user_name_popup_model.dart';

class UserNamePopupWidget extends StatefulWidget {
  const UserNamePopupWidget({
    super.key,
  ...
  @override
  State<UserNamePopupWidget> createState() => _UserNamePopupWidgetState();
}

class _UserNamePopupWidgetState extends State<UserNamePopupWidget> {
  late UserNamePopupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserNamePopupModel());
        ...
        children: [
                        ...
                        builder: (context) => TextFormField(
                          ...
                          onFieldSubmitted: (_) async {
                            if (functions.smscCanSendMessage(
                                _model.textController.text, FFAppState().otp)) {
          ...
          FFButtonWidget(
            onPressed: functions.isTextLessThen(
                ...
                ? null
                : () async {
                    if (_model.textController.text != currentUserDisplayName) {
